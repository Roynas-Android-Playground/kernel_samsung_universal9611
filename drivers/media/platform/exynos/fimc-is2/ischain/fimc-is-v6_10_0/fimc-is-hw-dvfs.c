...
DECLARE_DVFS_DT(FIMC_IS_SN_END,
		...
		{"rear4_preview_"				   , FIMC_IS_SN_REAR4_PREVIEW},
		{"rear4_capture_"				   , FIMC_IS_SN_REAR4_CAPTURE},
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR4_PREVIEW);
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR4_CAPTURE);
...
struct fimc_is_dvfs_scenario static_scenarios[] = {
	{
		...
		.scenario_id		= FIMC_IS_SN_REAR4_PREVIEW,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR4_PREVIEW),
		.check_func 	= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR4_PREVIEW),
	}, {
...
static struct fimc_is_dvfs_scenario dynamic_scenarios[] = {
	{
		...
		.scenario_id		= FIMC_IS_SN_REAR4_CAPTURE,
		.scenario_nm		= DVFS_SN_STR(FIMC_IS_SN_REAR4_CAPTURE),
		.keep_frame_tick	= FIMC_IS_DVFS_CAPTURE_TICK,
		.check_func 	= GET_DVFS_CHK_FUNC(FIMC_IS_SN_REAR4_CAPTURE),
	}, {
...
DECLARE_DVFS_CHK_FUNC(FIMC_IS_SN_REAR4_PREVIEW)
{
	...
	if ((position == SENSOR_POSITION_REAR4) &&
			(fps <= 30) &&
			(!setfile_flag))

...
#define MCSC_OUTPUT_DS		MCSC_OUTPUT3
...
struct param_stripe_input {
	...
	u32	overlap_width;	/* Overlapped horizontal region */
...
struct nfd_info {
	int		face_num;
	int		id[MAX_FACE_COUNT];
	struct fd_rect	rect[MAX_FACE_COUNT];
	int		score[MAX_FACE_COUNT];
	u32		frame_count;
	u32		rot[MAX_FACE_COUNT];    /* for NFD v3.0 */
	int		yaw[MAX_FACE_COUNT];
	int		pitch[MAX_FACE_COUNT];

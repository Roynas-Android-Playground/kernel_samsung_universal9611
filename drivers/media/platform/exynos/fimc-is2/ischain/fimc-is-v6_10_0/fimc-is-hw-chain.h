...
#define FIMC_IS_TAAISP_SIZE		(0x000F0000)	/* 960 KB */
#define TAAISP_MEDRC_SIZE		(0x00260000)	/* 2.375 MB */
...
#define XIU_D_CAM_S0		(SYSREG_CAM_BASE_ADDR + 0x0404)
#define XIU_D_CAM_S1		(SYSREG_CAM_BASE_ADDR + 0x0408)

#define CSIS0_QCH_EN_ADDR		0x14400004
#define CSIS1_QCH_EN_ADDR		0x14410004
#define CSIS2_QCH_EN_ADDR		0x14420004
#define CSIS3_QCH_EN_ADDR		0x14430004

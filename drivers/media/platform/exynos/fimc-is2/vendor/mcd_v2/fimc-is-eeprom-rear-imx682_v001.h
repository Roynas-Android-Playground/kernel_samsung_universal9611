#ifndef FIMC_IS_EEPROM_REAR_IMX682_GC5035_V001_H
#define FIMC_IS_EEPROM_REAR_IMX682_GC5035_V001_H

/* Reference File
 * Universal EEPROM map data V001_20200421_for_M31S_Ramen+_16K_EEPROM_(PDAF_IMX682_64M).xlsx
 */
...
#define REAR_PDAF_CHECKSUM_LEN       (0x2ABB - 0x22D0 + 0x1)
#define DUAL_CAL_MODEL_ID_LEN        (0x1C3F - 0x1C2C + 0x1)

struct rom_ae_cal_data rear_imx682_ae_cal_info = {
...
const struct rom_extend_cal_addr rear_imx682_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &rear_imx682_ae_cal_info,
	.next = NULL,
};

const struct fimc_is_vender_rom_addr rear_imx682_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_pdaf_module_info_start_addr           = 0x2ABC,
	.rom_pdaf_checksum_addr                    = 0x2AE8,
	...
	.rom_dual_cal_data2_start_addr             = 0x1A80,
	.rom_dual_cal_data2_size                   = (2080),
	...
	.extend_cal_addr                           = &rear_imx682_extend_cal_addr,
};

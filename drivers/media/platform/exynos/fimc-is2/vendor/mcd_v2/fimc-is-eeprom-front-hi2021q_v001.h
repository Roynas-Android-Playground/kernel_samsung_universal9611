#ifndef FIMC_IS_EEPROM_FRONT_HI2021Q_V001_H
...
#define SHADING_CHECKSUM_LEN (0x15FF - 0x0260 + 0x1)
#define SENSOR_CAL_CHECKSUM_LEN (0x1A1F - 0x1620 + 0x1)
/* Crosstalk cal data for SW remosaic */
//#define FRONT_XTALK_CAL_DATA_SIZE     (560)

const struct fimc_is_vender_rom_addr front_hi2021q_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_sensor_cal_module_info_start_addr      = 0x1A20,
	.rom_sensor_cal_checksum_addr               = 0x1A4C,

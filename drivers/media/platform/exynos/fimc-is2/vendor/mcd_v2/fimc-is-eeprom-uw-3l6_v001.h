#ifndef FIMC_IS_EEPROM_UW_3L6_V001_H
#define FIMC_IS_EEPROM_UW_3L6_V001_H

/* Reference File
 * Universal EEPROM map data V001_20200401_for_M31S_Ramen+_8K_(3L6_12M_UW).xlsx
 */
...
struct rom_ae_cal_data uw_3l6_ae_cal_info = {
...
const struct rom_extend_cal_addr uw_3l6_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &uw_3l6_ae_cal_info,
	.next = NULL,
};

const struct fimc_is_vender_rom_addr uw_3l6_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_oem_checksum_len                      = UW_OEM_CHECKSUM_LEN,
	...
	.extend_cal_addr                           = &uw_3l6_extend_cal_addr,
};

#endif /* FIMC_IS_EEPROM_UW_3L6_V001_H */

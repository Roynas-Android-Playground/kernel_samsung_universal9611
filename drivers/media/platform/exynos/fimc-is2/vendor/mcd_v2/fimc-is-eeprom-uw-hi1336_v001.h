#ifndef FIMC_IS_EEPROM_REAR3_HI1336_V001_H
#define FIMC_IS_EEPROM_REAR3_HI1336_V001_H

/* Reference File
 * Universal EEPROM map data V001_20190726_for_A51_Ramen+_8K_(Hi1336_12M_UW).xlsx
 */

#define FIMC_IS_REAR3_MAX_CAL_SIZE (8 * 1024)
#define REAR3_HEADER_CHECKSUM_LEN (0xFB - 0x00 + 0x1)
#define REAR3_OEM_CHECKSUM_LEN (0x0189 - 0x0100 + 0x1)
#define REAR3_AWB_CHECKSUM_LEN (0x023B - 0x1C0 + 0x1)
#define REAR3_SHADING_CHECKSUM_LEN (0x1C4F - 0x0260 + 0x1)

const struct fimc_is_vender_rom_addr uw_hi1336_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_header_checksum_len                    = REAR3_HEADER_CHECKSUM_LEN,

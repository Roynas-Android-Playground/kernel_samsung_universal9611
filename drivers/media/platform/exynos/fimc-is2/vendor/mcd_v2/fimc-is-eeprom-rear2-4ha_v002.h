...
/* Reference File
 * Universal EEPROM map data V001_20190826_for_XcoverPro_2019_Lassen_8K_(4HA_8M_UW).xlsx
 */

#ifndef FIMC_IS_REAR2_MAX_CAL_SIZE
#define FIMC_IS_REAR2_MAX_CAL_SIZE (8 * 1024)
#endif

#define REAR2_HEADER_CHECKSUM_LEN (0x00FB - 0x0000 + 0x1)
#define REAR2_OEM_CHECKSUM_LEN (0x0189 - 0x0100 + 0x1)
#define REAR2_AWB_CHECKSUM_LEN (0x023B - 0x01C0 + 0x1)
#define REAR2_SHADING_CHECKSUM_LEN (0x1C4F - 0x0260 + 0x1)
#define REAR2_AE_CHECKSUM_LEN		(0x1CCF - 0x1C70 + 1)
...
const struct fimc_is_vender_rom_addr rear2_4ha_cal_addr = {
	...
	.rom_header_main_mtf_data_addr = 0x40,

#ifndef FIMC_IS_EEPROM_FRONT_GD1_V001_H
#define FIMC_IS_EEPROM_FRONT_GD1_V001_H

/* Reference File
 * Universal EEPROM map data V001_20200401_for_M31S_Ramen+_8K_(GD1_32M_Front).xlsx
 */
...
#define FRONT_SHADING_CHECKSUM_LEN    (0x088C - 0x0260 + 0x1)
#define FRONT_SENSOR_CAL_CHECKSUM_LEN (0x1FAF - 0x08A0 + 0x1)

const struct fimc_is_vender_rom_addr front_gd1_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_shading_module_info_start_addr        = 0x088D,
	.rom_shading_checksum_addr                 = 0x089C,
	.rom_shading_checksum_len                  = FRONT_SHADING_CHECKSUM_LEN,

	.rom_sensor_cal_module_info_start_addr     = 0x1FB0,
	.rom_sensor_cal_checksum_addr              = 0x1FCC,
...
#endif /* FIMC_IS_EEPROM_FRONT_GD1_V001_H */

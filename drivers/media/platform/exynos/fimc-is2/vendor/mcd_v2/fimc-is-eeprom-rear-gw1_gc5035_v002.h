#ifndef FIMC_IS_EEPROM_REAR_GW1_GC5035_V001_H
#define FIMC_IS_EEPROM_REAR_GW1_GC5035_V001_H

/* Reference File
 * Universal EEPROM map data V002_20191122_for_M31_2019_RAMEN_16K_EEPROM_(PDAF_GW1_64M_GC5035_5M_Bokeh).xlsx
 */
...
#define REAR_SENSOR_CAL_CHECKSUM_LEN (0x1A11 - 0x0970 + 0x1)
#define REAR_AE_CHECKSUM_LEN         (0x1A60 - 0x1A30 + 0x1)
#define REAR_DUAL_CHECKSUM_LEN       (0x229F - 0x1A80 + 0x1)
#define REAR_PDAF_CHECKSUM_LEN       (0x297F - 0x22D0 + 0x1)
#define DUAL_CAL_MODEL_ID_LEN        (0x1C3F - 0x1C2C + 0x1)

struct rom_ae_cal_data rear_gw1_ae_cal_info = {
...
struct rom_dual_tilt_cal_data rear_gw1_dual_cal_info = {
	.rom_dual_tilt_dll_modelID_addr            = 0x1C2C,
	.rom_dual_tilt_dll_modelID_size            = DUAL_CAL_MODEL_ID_LEN,
};

struct rom_extend_cal_addr rear_gw1_extend_cal_addr_2 = {
	.name = EXTEND_DUAL_CAL,
	.data = &rear_gw1_dual_cal_info,
	.next = NULL,
};

const struct rom_extend_cal_addr rear_gw1_extend_cal_addr = {
	.name = EXTEND_AE_CAL,
	.data = &rear_gw1_ae_cal_info,
	.next = &rear_gw1_extend_cal_addr_2,
};

const struct fimc_is_vender_rom_addr rear_gw1_gc5035_cal_addr = {
	/* Set '-1' if not used */
	...
	.rom_header_cal_data_start_addr            = 0x20,
	...
	.rom_sensor_cal_module_info_start_addr     = 0x1A12,
	...
	.rom_pdaf_module_info_start_addr           = 0x2980,
	.rom_pdaf_checksum_addr                    = 0x29AC,
	...
	.extend_cal_addr                           = &rear_gw1_extend_cal_addr,
};

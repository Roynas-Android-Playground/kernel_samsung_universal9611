 ...
 ***/
/* Related EEPROM CAL */
#if defined(CONFIG_CAMERA_MMS_V31) || defined(CONFIG_CAMERA_FXT_V41)
...
enum sensor_imx616_mode_enum {
	...
	IMX616_MODE_2X2BIN_3264x1472_30FPS,
	IMX616_MODE_2X2BIN_2448x2448_30FPS,
	IMX616_MODE_2X2BIN_2144x1200_120FPS,
	...
	IMX616_MODE_2X2BIN_3264x2448_60FPS,

	IMX616_MODE_H2V2_1632x1224_120FPS,
	/* FULL Remosaic */
	IMX616_MODE_REMOSAIC_START,
	IMX616_MODE_REMOSAIC_6528x4896_24FPS = IMX616_MODE_REMOSAIC_START,
	...
	IMX616_MODE_QBCHDR_CAPABLE_END = IMX616_MODE_2X2BIN_SEAMLESS_3264x2448_24FPS,
	IMX616_MODE_QBCHDR_END = IMX616_MODE_QBCHDR_CAPABLE_END,
	/* -- QBC 3HDR */

	/* ++ Seamless Transition Mode, only used internally in CIS driver */
	IMX616_MODE_TRANSITION_2X2BIN_to_QBCHDR,
	IMX616_MODE_TRANSITION_QBCHDR_to_2X2BIN,
...
/* IS_3HDR(struct fimc_is_cis *cis, u32 mode): check if mode is 3dhdr */
...
/* IS_3HDR_MODE(struct fimc_is_cis *cis) */

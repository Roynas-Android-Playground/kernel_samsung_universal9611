...
/* Reference : 4HA_EVT00_Setfile_REV22.xlsx */
/* Mode Setting : 26M 4Lane - 671Mbps */
...
/* 26M_4Lane - 671Mbps, 3264 x 2448 @ 30fps */
...
/* 26M_4Lane - 671Mbps, 3264 x 2040 @ 30fps */
const u32 sensor_4ha_setfile_B_3264x2040_30fps[] = {
	0x0136, 0x1A, 0x01,
	0x0137, 0x00, 0x01,
	0x0301, 0x04, 0x01,
	0x0305, 0x05, 0x01,
...
/* 26M_4Lane - 671Mbps, 3264 x 1836 @ 30fps */
...
/* 26M_4Lane - 671Mbps, 3264 x 1588 @ 30fps */
...
/* 26M_4Lane - 671Mbps, 3264 x 1504 @ 30fps */
const u32 sensor_4ha_setfile_B_3264x1504_30fps[] = {
	0x0136, 0x1A, 0x01,
	0x0137, 0x00, 0x01,
	0x0301, 0x04, 0x01,
	0x0305, 0x05, 0x01,
...
/* 26M_4Lane - 671Mbps, 2448 x 2448 @ 30fps */
...
/* 26M_4Lane - 671Mbps, 1632 x 1224 @ 30fps */
...
/* 26M_4Lane - 671Mbps, 1632 x 1224 @ 60fps */
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_3264x2040_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_4ha_pllinfo_B_3264x1504_30fps = {
	EXT_CLK_Mhz * 1000 * 1000,	/* ext_clk */
	671000000,			/* mipi_datarate = OPSYCK */
	280800000,			/* VT picxel clk */
	2538,				/* frame_length_lines */
...
static const u32 *sensor_4ha_setfiles_B[] = {
	...
	sensor_4ha_setfile_B_3264x2040_30fps,
	sensor_4ha_setfile_B_3264x1836_30fps,
	sensor_4ha_setfile_B_3264x1588_30fps,
	sensor_4ha_setfile_B_3264x1504_30fps,
...
static const u32 sensor_4ha_setfile_B_sizes[] = {
	...
	ARRAY_SIZE(sensor_4ha_setfile_B_3264x2040_30fps),
	ARRAY_SIZE(sensor_4ha_setfile_B_3264x1836_30fps),
	ARRAY_SIZE(sensor_4ha_setfile_B_3264x1588_30fps),
	ARRAY_SIZE(sensor_4ha_setfile_B_3264x1504_30fps),
...
static const struct sensor_pll_info_compact *sensor_4ha_pllinfos_B[] = {
	...
	&sensor_4ha_pllinfo_B_3264x2040_30fps,
	&sensor_4ha_pllinfo_B_3264x1836_30fps,
	&sensor_4ha_pllinfo_B_3264x1588_30fps,
	&sensor_4ha_pllinfo_B_3264x1504_30fps,

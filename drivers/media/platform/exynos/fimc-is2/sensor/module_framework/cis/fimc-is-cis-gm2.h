...
#define SENSOR_GM2_MAX_COARSE_INTEGRATION_TIME              (65503)
#define SENSOR_GM2_MAX_CIT_LSHIFT_VALUE        (11)

#define SENSOR_GM2_FRM_LENGTH_LINE_LSHIFT_ADDR (0x0702)
#define SENSOR_GM2_CIT_LSHIFT_ADDR             (0x0704)

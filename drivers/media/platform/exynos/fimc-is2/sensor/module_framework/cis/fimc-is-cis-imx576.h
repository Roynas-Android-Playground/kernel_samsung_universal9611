...
#define SENSOR_IMX576_LRC_CAL_BASE_REAR           (0x1550)
...
#define SENSOR_IMX576_QUAD_SENS_CAL_BASE_REAR     (0x1110)
...
#define IMX576J_PDAF_SUPPORT_CALMAP_VER           (49) //'2'
#define IMX576J_PROJECT_NAME_FOR_MODULE_CHECK     "XCPROLR1"
#endif

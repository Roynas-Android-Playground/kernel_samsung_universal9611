...
static struct fimc_is_sensor_cfg config_imx616[] = {
	...
	FIMC_IS_SENSOR_CFG_EX(1968, 1968,  30, 0, 11, CSI_DATA_LANES_4, 2054, CSI_MODE_DT_ONLY, PD_NONE, EX_NONE,
		...
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 12 : 2X2BIN_3264x2448_60FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  60, 0, 12, CSI_DATA_LANES_4, 2054, CSI_MODE_DT_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 13 : H2V2_1632x1224_120FPS */
	FIMC_IS_SENSOR_CFG_EX(1632, 1224,  120, 0, 13, CSI_DATA_LANES_4, 2054, CSI_MODE_DT_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1632, 1224),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 14 : REMOSAIC_6528x4896_24FPS */
	FIMC_IS_SENSOR_CFG_EX(6528, 4896,  24, 0, 14, CSI_DATA_LANES_4, 2218, CSI_MODE_DT_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 6528, 4896),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 15 : 68 deg Crop REMOSAIC_5264x3948_24FPS */
	FIMC_IS_SENSOR_CFG_EX(5264, 3948,  24, 0, 15, CSI_DATA_LANES_4, 2218, CSI_MODE_DT_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 5264, 3948),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 16 : QBCHDR_3264x2448_24FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  24, 0, 16, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_3DHDR,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
	...
	/* 17 : QHDR_SEAMLESS_3264x1836_30FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1836,  30, 0, 17, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_3DHDR,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1836),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(0, HW_FORMAT_USER1, 4080, 2), VC_OUT(HW_FORMAT_USER1, VC_EMBEDDED2, 4080, 2),
		VC_IN(0, HW_FORMAT_USER2, 4080, 3),       VC_OUT(HW_FORMAT_USER2, VC_EMBEDDED, 4080, 3)),
	/* 18 : 2X2BIN_SEAMLESS_3264x1836_30FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1836,  30, 0, 18, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_SEAMLESS_TETRA,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1836),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(0, HW_FORMAT_USER1, 4080, 2), VC_OUT(HW_FORMAT_USER1, VC_EMBEDDED2, 4080, 2),
		VC_IN(0, HW_FORMAT_USER2, 4080, 3),       VC_OUT(HW_FORMAT_USER2, VC_EMBEDDED, 4080, 3)),
	/* 19 : 2X2BIN_SEAMLESS_3264x2448_24FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  24, 0, 19, CSI_DATA_LANES_4, 2218, CSI_MODE_DT_ONLY, PD_NONE, EX_SEAMLESS_TETRA,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),

...
#include "fimc-is-device-module-hi1336.h"
...
static struct fimc_is_sensor_cfg config_hi1336[] = {
	/* Full Crop(4128x3096) 4:3 */
	FIMC_IS_SENSOR_CFG_EX(4128, 3096,  30, 0, 0, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4128, 3096),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(4128x2324) 16:9 */
	FIMC_IS_SENSOR_CFG_EX(4128, 2324,  30, 0, 1, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4128, 2324),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(4128x1908) 19.5:9 */
	FIMC_IS_SENSOR_CFG_EX(4128, 1908,  30, 0, 2, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4128, 1908),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3088x3088) 1:1 */
	FIMC_IS_SENSOR_CFG_EX(3088, 3088,  30, 0, 3, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3088, 3088),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x2556) 4:3 */
	FIMC_IS_SENSOR_CFG_EX(3408, 2556,  30, 0, 4, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3408, 2556),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x1916) 16:9 */
	FIMC_IS_SENSOR_CFG_EX(3408, 1916,  30, 0, 5, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3408, 1916),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x1576) 19.5:9 */
	FIMC_IS_SENSOR_CFG_EX(3408, 1576,  30, 0, 6, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3408, 1576),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x2556) 4:3 */
	FIMC_IS_SENSOR_CFG_EX(2064, 1548,  30, 0, 7, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2064, 1548),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x1916) 16:9 */
	FIMC_IS_SENSOR_CFG_EX(2064, 1160,  30, 0, 8, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2064, 1160),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(3408x1576) 19.5:9 */
	FIMC_IS_SENSOR_CFG_EX(1696, 1272,  30, 0, 9, CSI_DATA_LANES_4, 748, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1696, 1272),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(2560x2560) 1:1 */
	FIMC_IS_SENSOR_CFG_EX(1696, 952,  30, 0, 10, CSI_DATA_LANES_4, 748, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1696, 952),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),		
	/* 4-binning FastAE */
	FIMC_IS_SENSOR_CFG_EX(1024, 768,  120, 0, 11, CSI_DATA_LANES_4, 364, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1024, 768),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
 ...
 *  [ 3 ] 2000 x 1500(4:3)      @30,  MIPI lane: 4, MIPI data rate(Mbps/lane):  748, Mclk(Mhz): 26
 *  [ 4 ] 2000 x 1124(16:9)     @30,  MIPI lane: 4, MIPI data rate(Mbps/lane):  748, Mclk(Mhz): 26
 *
...
static struct fimc_is_sensor_cfg config_hi1336[] = {
	...
	FIMC_IS_SENSOR_CFG_EX(4000, 3000,  30, 0, 1, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4000, 3000),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* Full Crop(4000x2256) 16:9 */
	FIMC_IS_SENSOR_CFG_EX(4000, 2256,  30, 0, 2, CSI_DATA_LANES_4, 1456, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4000, 2256),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 2-binning Crop(2000x1500) 4:3 */
	FIMC_IS_SENSOR_CFG_EX(2000, 1500,  30, 0, 3, CSI_DATA_LANES_4,  748, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2016, 1512),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 2-binning Crop(2000x1124) 16:9 */
	FIMC_IS_SENSOR_CFG_EX(2000, 1124,  30, 0, 4, CSI_DATA_LANES_4,  748, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2000, 1124),  VC_OUT(HW_FORMAT_RAW10,   VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),      VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 4-binning FastAE */
	FIMC_IS_SENSOR_CFG_EX(992, 744,  120, 0, 5, CSI_DATA_LANES_4, 364, CSI_MODE_CH0_ONLY, PD_NONE, EX_NONE,
...
static int __init sensor_module_hi1336_probe(struct platform_device *pdev)
{
	...
	module->client = NULL;
	module->active_width = HI1336_ACTIVE_WIDTH;
	module->active_height = HI1336_ACTIVE_HEIGHT;

...
static struct fimc_is_sensor_cfg config_module_5e9[] = {
	...
	FIMC_IS_SENSOR_CFG(1280, 720,  30, 0, 15, CSI_DATA_LANES_2, 874, CSI_MODE_VC_ONLY, PD_NONE,
		...
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 960x960@30fps */
	FIMC_IS_SENSOR_CFG(960, 960,  30, 0, 16, CSI_DATA_LANES_2, 874, CSI_MODE_VC_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 960, 960), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 640x480@120fps */
	FIMC_IS_SENSOR_CFG(640, 480,  120, 0, 17, CSI_DATA_LANES_2, 874, CSI_MODE_VC_ONLY, PD_NONE,
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	gpio_camio_1p8_en = of_get_named_gpio(dnode, S5K5E9_IOVDD, 0);
	...
	gpio_cam_1p2_en = of_get_named_gpio(dnode, S5K5E9_DVDD, 0);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, pin_1p2.gpio, S5K5E9_DVDD, pin_1p2.type, 1, 500);  /* RCAM2_DVDD_1P2 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_cam_2p8_en, S5K5E9_AVDD, PIN_OUTPUT, 1, 500); /* RCAM2_AVDD_2P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, pin_1p8.gpio, S5K5E9_IOVDD, pin_1p8.type, 1, 500); /* CAM_VDDIO_1P8 */	 
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, pin_1p2.gpio, S5K5E9_DVDD, pin_1p2.type, 0, 0); /* RCAM2_DVDD_1P2 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, pin_1p8.gpio, S5K5E9_IOVDD, pin_1p8.type, 0, 0); /* CAM_VDDIO_1P8 */

	/* ROM powerOn */
#ifdef SENSOR_OTP_5E9
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_reset, SENSOR_RESET_LOW, PIN_OUTPUT, 0, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, pin_1p2.gpio, S5K5E9_DVDD, pin_1p2.type, 1, 500);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_cam_2p8_en, S5K5E9_AVDD, PIN_OUTPUT, 1, 500);
#endif
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, pin_1p8.gpio, S5K5E9_IOVDD, pin_1p8.type, 1, 500); /* CAM_VDDIO_1P8 */
#ifdef SENSOR_OTP_5E9
	...
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, pin_1p2.gpio, S5K5E9_DVDD, pin_1p2.type, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_cam_2p8_en, S5K5E9_AVDD, PIN_OUTPUT, 0, 0);
#endif
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, pin_1p8.gpio, S5K5E9_IOVDD, pin_1p8.type, 0, 0); /* CAM_VDDIO_1P8 */	 

...
#define RCAM_AF_VDD     "vdd_ldo37"
#define IMX576_IOVDD    "CAM_VDDIO_1P8"
#define IMX576_AVDD     "RCAM1_AVDD_2P8"
#define IMX576_DVDD     "RCAM1_DVDD_1P05"
#endif
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, IMX576_IOVDD, PIN_REGULATOR, 1, 0); /* CAM_VDDIO_1P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, IMX576_AVDD, PIN_REGULATOR, 1, 0); /* RCAM1_AVDD_2P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, IMX576_DVDD, PIN_REGULATOR, 1, 0); /* RCAM1_DVDD_1P05 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_none, RCAM_AF_VDD, PIN_REGULATOR, 1, 5000); /* RCAM1_AFVDD_2P8 */
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, "pin", PIN_FUNCTION, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, IMX576_AVDD, PIN_REGULATOR, 0, 0); /* RCAM1_AVDD_2P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, IMX576_DVDD, PIN_REGULATOR, 0, 0); /* RCAM1_DVDD_ 1P05 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, IMX576_IOVDD, PIN_REGULATOR, 0, 0); /* CAM_VDDIO_1P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_none, RCAM_AF_VDD, PIN_REGULATOR, 0, 0); /* RCAM1_AFVDD_2P8 */


	/* READ_ROM - POWER ON */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, RCAM_AF_VDD, PIN_REGULATOR, 1, 0); /* RCAM1_AFVDD_2P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, IMX576_IOVDD, PIN_REGULATOR, 1, 0); /* CAM_VDDIO_1P8 */
	/* READ_ROM - POWER OFF */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, RCAM_AF_VDD, PIN_REGULATOR, 0, 7000); /* RCAM1_AFVDD_2P8 */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, IMX576_IOVDD, PIN_REGULATOR, 0, 0); /* CAM_VDDIO_1P8 */

...
#define SENSOR_TYPE_DEVICE_PRIVATE_BASE             (SENSOR_TYPE_DEVICE_ORIENTATION)
...
#define SENSOR_TYPE_DEVICE_ORIENTATION_WU           (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 25)
#define SENSOR_TYPE_SAR_BACKOFF_MOTION              (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 27)
#define SENSOR_TYPE_MAX                             (SENSOR_TYPE_DEVICE_PRIVATE_BASE + 28)

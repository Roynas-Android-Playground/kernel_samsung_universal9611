...
static unsigned char SEQ_ASWIRE_OFF[] = {
	0xD5,
	0x82, 0xFF, 0x5C, 0x44, 0xBF, 0x89, 0x00, 0x00,
	0x03, 0x01,
};
...
static unsigned char SEQ_ASWIRE_OFF[] = {
	0xD5,
	0x83, 0xFF, 0x5C, 0x44, 0x89, 0x89, 0x00, 0x00,
	0x00, 0x00, 0x00
};
#endif
...
static unsigned char SEQ_ACL_DIM_SETTING[] = {
	0xB9,
	0x41, 0xFE, 0x20 /* start 50% 32 frame */
};

static unsigned char SEQ_ELVSS_SET[] = {
	0xB7,
	0x01, 0x53, 0x28, 0x4D, 0x00,
	0x90,	/* 6th: ELVSS return */
	0x04,	/* 7th para : Smooth transition 4-frame */
	0x00,	/* 8th: Normal ELVSS OTP */
	0x00,	/* 9th: HBM ELVSS OTP */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x41,
	0x41, 0x42, 0x42, 0x42, 0x42, 0x83, 0xC3, 0x83,
	0xC3, 0x83, 0xC3, 0x03, 0x03, 0x03, 0x03, 0x03,

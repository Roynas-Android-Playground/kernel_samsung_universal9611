...
static int __init exynos9610_secgpio_get_nr_gpio(void)
{
	unsigned int i, j;
	int nr_gpio = 0;
	const struct samsung_pin_ctrl *pin_ctrl = exynos9610_of_data.ctrl;
	unsigned int num_ctrl = exynos9610_of_data.num_ctrl;
...
static struct gpio_dvs_t exynos9610_secgpio_dvs = {
	.result = &gpiomap_result,
	.check_gpio_status = check_gpio_status,
	.skip_grps = "gpb gph", /* AUDIO, CHUB*/
};

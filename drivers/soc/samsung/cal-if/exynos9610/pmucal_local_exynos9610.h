...
struct pmucal_seq g3d_save[] = {
	...
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_G3D_QCH", 0x11430000, 0x301c, (0x7 << 0), (0x6 << 0), 0x11860000, 0x4064, (0xf << 0), (0xF << 0)),
};

struct pmucal_seq g3d_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "QCH_CON_G3D_QCH", 0x11430000, 0x301c, (0x7 << 0), (0x2 << 0), 0x11860000, 0x4064, (0xf << 0), (0xF << 0)),
